...
def normalize_form_payload(data):
    ...
    tech_map = {
        ...
        'qdca_disjuntor_ca': ('qdca_disjuntor_ca',),
        'qdca_num_dps': ('qdca_num_dps',),
        'qdca_observacoes': ('qdca_observacoes',),
        'qdca_bitola_ca': ('qdca_bitola_ca',),
        'qdca_bitola_fase_a': ('qdca_bitola_fase_a',),
        'qdca_bitola_fase_b': ('qdca_bitola_fase_b',),
        'qdca_bitola_fase_c': ('qdca_bitola_fase_c',),
        'qdca_corrente_proj_fase_a': ('qdca_corrente_proj_fase_a',),
        'qdca_corrente_proj_fase_b': ('qdca_corrente_proj_fase_b',),
        'qdca_corrente_proj_fase_c': ('qdca_corrente_proj_fase_c',),
        'qdca_corrente_proj': ('qdca_corrente_proj',),
        'qdca_corrente_proj_tronco': ('qdca_corrente_proj_tronco',),
        'qdca_tem_disj_acoplamento': ('qdca_tem_disj_acoplamento',),
        'qdca_disjuntor_geral': ('qdca_disjuntor_geral',),
        'qdca_bitola_tronco': ('qdca_bitola_tronco',),
    }
